package com.huchao.schoolgroup.message.view;
...
import com.yuntongxun.schoolgroup.common.base.CCPTabView;
import com.yuntongxun.schoolgroup.common.utils.DensityUtil;
...
public class MessageUITabView extends RelativeLayout implements View.OnClickListener{
  ...
  public MessageUITabView(Context context) {
    super(context);
    init();
  }

  public MessageUITabView(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
    init();
  }

  public MessageUITabView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }
  ...
  private void init() {
    ...
    addView(layout, new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT));
   ...
   TabViewHolder tabViewMain = createTabView(TAB_VIEW_MAIN);
    tabViewMain.tabView.setText(R.string.message_tab_view_name_1);
    LinearLayout.LayoutParams enbGroupLayoutParams = new LinearLayout.LayoutParams(0, getResources().getDimensionPixelSize(R.dimen.DefaultTabbarHeight));
    ...
    tabViewSecond.tabView.setText(R.string.message_tab_view_name_2);
    LinearLayout.LayoutParams secondLayoutParams = new LinearLayout.LayoutParams(0, getResources().getDimensionPixelSize(R.dimen.DefaultTabbarHeight));
...
//
//    // 讨论组
//    CCPLauncherUITabView.TabViewHolder tabViewDisGroup = createTabView(TAB_VIEW_FOUR);
...
//    mFourTabView = tabViewDisGroup;
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    if(mIndicatorBitmap == null || mIndicatorBitmap.getWidth() != mTabViewBaseWidth) {
      ...
      LogUtil.d(LogUtil.getLogUtilsTag(CCPLauncherUITabView.class), "sharp width changed, from " + from + " to " + width);
      mIndicatorBitmap = Bitmap.createBitmap(width, DensityUtil.fromDPToPix(getContext(), 4), Bitmap.Config.ARGB_8888);
